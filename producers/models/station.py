...
class Station(Producer):
    ...
    def __init__(self, station_id, name, color, direction_a=None, direction_b=None):
        ...
        #
        #
        #topic_name = f"com.udacity.arrivals.station.{station_name}"
    ...
    def run(self, train, direction, prev_station_id, prev_direction):
        ...
        #
        #
        direction = "a" if self.dir_a is not None else "b"
        self.producer.produce(
            ...
            value={
                ...
                "prev_direction" : prev_direction if prev_direction else None ,
                "prev_station_id" : int(prev_station_id) if prev_station_id else None
            },
        )
